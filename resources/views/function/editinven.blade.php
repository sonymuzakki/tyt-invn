      ...
      <section class="Form">
        <div class="card">
            <div class="">
                <div class="card">
                    <div class="card-body">
                        <form action="/updateinven/ {{ $data->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-6 mb-2">
                                ...
                                <input type="text" class="form-control" name="hostname" id="exampleFormControlInput1" placeholder="" value="{{ $data->hostname }}">
                            </div>
                            <div class="col-6 mb-2">
                                <label for="exampleFormControlInput1" class="form-label">Ip Address</label>
                                <input type="text" class="form-control" name="ipAddress" id="exampleFormControlInput1" placeholder="" value="{{ $data->ipAddress }}">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-2">
                                ...
                                <input type="text" class="form-control" name="companyemail" id="exampleFormControlInput1" placeholder="" value="{{ $data->companyemail }}">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-2">
                                ...
                                <input type="text" class="form-control" name="useraccount" id="exampleFormControlInput1" placeholder="" value="{{ $data->useraccount }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-2">
                                ...
                                <input type="text" class="form-control" name="anydeskId" id="exampleFormControlInput1" placeholder="" value="{{ $data->anydeskId }}">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-6 mb-2">
                                ...
                                <input type="text" class="form-control" name="akunOffice" id="exampleFormControlInput1" placeholder="" value="{{ $data->akunOffice }}">
                            </div>
                            <div class="col-6 mb-2">
